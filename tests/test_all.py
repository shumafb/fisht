...
def test_get_phone_info():
    assert numvox(9994442244) == {'code': '999', 'num': '4442244', 'full_num': '9994442244', 'operator': 'Интернод', 'region': 'г. Москва и Московская область'}
    assert numvox(1992224422) == None
